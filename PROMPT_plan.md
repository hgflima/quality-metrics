...
0a. Study docs/mvp/* (use up to 250 parallel Sonnet subagents)
0b. Study specs/* if any additional specs exist there
0c. Study @IMPLEMENTATION_PLAN.md (if exists)
0d. Study @AGENTS.md (if exists)
0e. Study src/lib/* (shared utilities to understand patterns)
0f. Reference: src/* (as needed for gap analysis)
